...
public class MBDPMatrix {
	...
	private String DATA_SOURCE;// 数据�?
	private String CYCLE; // 日批or月批
	private HashSet<String> steps = new HashSet<String>();// 步骤

	private HashMap<HashMap<String, String>, Boolean> mbdpMatrix = new HashMap<HashMap<String, String>, Boolean>(); // 全部步骤的前后关联关�?
	...
	// 根据 mbdp_ID 计算 MBDPMatrix对象�?hashCode() 返回�?
	public int hashCode() {
